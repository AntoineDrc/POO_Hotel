Ce projet simule la gestion d'un hôtel, intégrant plusieurs classes (Hôtel, Chambre, Client, Réservation) en utilisant la programmation orientée objet (POO) en PHP. L'application permet de gérer les chambres, les réservations et les clients d'un hôtel, tout en offrant un suivi des disponibilités et des réservations effectuées.

## Fonctionnalités principales

- **Gestion des hôtels** : Chaque hôtel a un nom, une adresse, un nombre d'étoiles, et une liste de chambres.
- **Gestion des chambres** : Les chambres ont un numéro, un prix, une disponibilité et peuvent être équipées de Wi-Fi.
...
2. **Chambre** : Représente une chambre d'hôtel avec son prix, son statut (disponible ou réservé) et ses services (Wi-Fi).
